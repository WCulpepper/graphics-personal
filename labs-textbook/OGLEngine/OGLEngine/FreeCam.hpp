...
inline void FreeCam::recomputeOrientation() {
...
inline void FreeCam::moveForward(GLfloat movementFactor) {
    _position += _direction * movementFactor;
    _updateFreeCameraViewMatrix();
}

inline void FreeCam::moveBackward(GLfloat movementFactor) {
    _position -= _direction * movementFactor;
    _updateFreeCameraViewMatrix();
}

inline void FreeCam::_updateFreeCameraViewMatrix() {
